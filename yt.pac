function FindProxyForURL(url, host) {
  ...
  if (dnsDomainIs(host, ".ggpht.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, ".googleapis.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, ".google.com") ) return "SOCKS 192.168.50.1:1337";
  ...
  if (dnsDomainIs(host, ".gstatic.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, ".googlesyndication.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, ".google") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, ".google-analytics.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, "ggpht.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, "googleapis.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, "googlevideo.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, "youtube.com") ) return "SOCKS 192.168.50.1:1337";
  ...
  if (dnsDomainIs(host, "gstatic.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, "googlesyndication.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, "googleusercontent.com") ) return "SOCKS 192.168.50.1:1337";
  if (dnsDomainIs(host, "google-analytics.com") ) return "SOCKS 192.168.50.1:1337";
